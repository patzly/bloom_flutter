...
void main() {
  ...
  testWidgets('calls controller.setScreenTimeMax after selecting new duration', (tester) async {
    ...
    verify(() => mockController.setScreenTimeMax(Duration(minutes: 10))).called(1);
